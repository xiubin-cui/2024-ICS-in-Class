...
int main(int argc, char **argv) {
  ...
  }
  {
    double a;
    int b;
    char c = (argc < 4 ? main(4 - 51 / 26, argv)
                       : *argv[1] * (int)11 / 26 + 222 / 31 +
                             ~~~~~~~~~~~~~~~~~~~~~~~~*argv[1] * (int)-!7.584) &
             15;
    b = (*argv[1] % 50 + 7) % 9 * (3 * 367 >> c & 1);
    c +=
